class Audio < ActiveRecord::Base
  ...
  def self.maximum_audio_file_age
    ...
    audio_ages.max / 86_400 unless audio_ages.empty?
  end
  ...
  def self.minimum_audio_file_age
    ...
    audio_ages.min / 86_400 unless audio_ages.empty?
  end
  ...
  def self.average_audio_file_size
    ...
    average_size / number_of_audios / 1000 unless number_of_audios == 0
  end
  ...
  def self.minimum_audio_file_size
    ...
    audio_sizes.min / 1000 unless audio_sizes.empty?
  end
  ...
  def self.maximum_audio_file_size
    ...
    audio_sizes.max / 1000 unless audio_sizes.empty?
  end
end
