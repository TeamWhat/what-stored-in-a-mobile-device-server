class VisualizationsController < ApplicationController
  def index
    ...
    average_video_age: Video.average_video_file_age,
    ...
    minimum_video_age: Video.minimum_video_file_age,
    maximum_video_age: Video.maximum_video_file_age,
    ...
    average_video_size: Video.average_video_file_size,
    ...
    minimum_video_size: Video.minimum_video_file_size,
    maximum_video_size: Video.maximum_video_file_size,
    }
  end
end
